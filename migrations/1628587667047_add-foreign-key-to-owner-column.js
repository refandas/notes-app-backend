...
exports.up = (pgm) => {
  // membuat user baru.
  pgm.sql("INSERT INTO users(id, username, password, fullname) VALUES('old_notes', 'old_notes', 'old_notes', 'old_noted')");
...
exports.down = (pgm) => {
  ...
  // mengubah nilai owner old notes pada note menjadi NULL
